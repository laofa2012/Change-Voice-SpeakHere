...
void FaPlayer::AQBufferCallback(void *					inUserData,
								AudioQueueRef			inAQ,
								AudioQueueBufferRef		inCompleteAQBuffer) 
{
	FaPlayer *THIS = (FaPlayer *)inUserData;
...
void FaPlayer::isRunningProc (  void *              inUserData,
                              AudioQueueRef           inAQ,
...
void FaPlayer::CalculateBytesForTime (CAStreamBasicDescription & inDesc, UInt32 inMaxPacketSize, Float64 inSeconds, UInt32 *outBufferSize, UInt32 *outNumPackets)
{
...
OSStatus FaPlayer::StartQueue(BOOL inResume)
{	
...
void FaPlayer::CreateQueueForFile(CFStringRef inFilePath) 
{	
...
void FaPlayer::SetupNewQueue() 
{
	XThrowIfError(AudioQueueNewOutput(&mDataFormat, FaPlayer::AQBufferCallback, this, 
...
void FaPlayer::DisposeQueue(Boolean inDisposeFile)
{
	if (mQueue)
	{
